                    ...
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        <div class="form-bottom">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="请输入用户名" class="form-username form-control" v-model="user.username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">密 码</label>
                                <input type="password" name="form-password" placeholder="请输入密码" class="form-password form-control" v-model="user.password">
                            </div>
