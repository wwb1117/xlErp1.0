                    ...
                    style="width: 100%">
                        ...
                        label="采购数">
                            <template slot-scope="scope">
                                ...
                                <div v-if="scope.row.selfNum !== ''">
                                    <el-input @keyup.native="unitTatalEvent(scope)" v-model="scope.row.purchaseNum"></el-input>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        label="采购单价(元)">
                            <template slot-scope="scope">
                                ...
                                <div v-if="scope.row.selfNum !== ''">
                                    <el-input @keyup.native="unitTatalEvent(scope)" v-model="scope.row.unitPrice"></el-input>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column
